...
pub fn app() -> App<'static, 'static> {
    app_from_crate!()
        ...
        .arg(
            Arg::with_name("session_ipc_path")
                .takes_value(true)
        ...
        .arg(
            Arg::with_name("ipc_socket_owner")
                .takes_value(true)
        ...
        .arg(
            Arg::with_name("ipc_socket_group")
                .takes_value(true)
                .help(
                    "Change gid of the group of all IPC sockets. \
        ...
        .arg(
            Arg::with_name("ipc_socket_permissions")
                .takes_value(true)
                .help(
                    "Set permissions mask of the group of all IPC sockets. \
